...
export default function DataTable({
    ...
    const [search, setSearch] = useState(filters?.search || 'id');
    ...
    const renderCell = (item: any, column: any, index: number) => {
        ...
        if (column.type === 'bage') {
            return (
                <span
                    className="inline-flex items-center rounded-full bg-blue-100 px-2.5 py-0.5 text-xs font-medium text-blue-800 dark:bg-blue-950 dark:text-blue-300">
                    {value}
                </span>
            );
        }
        ...
        if (column.type === 'boolean') {
            return value ? (
                ...
                <span
                    className="inline-flex items-center rounded-full bg-red-100 px-2.5 py-0.5 text-xs font-medium text-red-800 dark:bg-red-900 dark:text-red-300">
                    No
                </span>
            );
        }
        ...
        <div className="w-full bg-white dark:bg-gray-900">
            <div className="px-6 py-4">
                ...
                <div className="overflow-hidden rounded-lg border border-gray-200 shadow dark:border-gray-700">
                    <table
                        className="min-w-full divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-900">
                        <thead>
                ...
                <div className="mt-6 flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-1">
                        <button
                            className="disabled: relative inline-flex items-center rounded-md border border-gray-300 bg-white px-1 py-2 text-sm font-medium text-gray-700 opacity-50 hover:bg-gray-50 disabled:cursor-not-allowed dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700">
