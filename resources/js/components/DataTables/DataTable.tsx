...
type WayFinderRoute<K extends Method | Method[]> = (
    args: any,
...
export default function DataTable({
    ...
    routeName: string;
    filters: any;
    viewRoute: WayFinderRoute<'get'>;
    canViewResource: boolean;
    canCreateResource: boolean;
    canEditResource: boolean;
    canDeleteResource: boolean;
    icon: React.ElementType;
    createRoute: WayFinderRoute<'get'>;
    editRoute: WayFinderRoute<'get'>;
        ...
        return (
            <div className="flex space-x-2">
                {canViewResource && (
                    <button
                        ...
                        onClick={() =>
                            ...
                            router.visit(viewRoute(item.id))
                        }
                    >
                        View
                    </button>
                ...
                {canEditResource && (
                    <button
                        className="rounded-md bg-blue-50 px-2 py-1 text-xs font-medium text-blue-600 hover:bg-blue-100 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none dark:bg-blue-900 dark:text-blue-300 dark:hover:bg-blue-800"
                        onClick={() => router.visit(editRoute(item.id))}
                    >
                        Edit
                    </button>
                )}
                ...
                <div className="mt-6 flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-1">
                        <button
                            ...
                            className="relative inline-flex items-center rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-50 hover:text-gray-700 disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
                        >
                        ...
                        {data.links &&
                            data.links.map((link: any, index: number) => {
                                // Сокрытие кнопок Previous и Next
                                if (
                                ...
                                return (
                                    <button
                                        key={index}
                                        className={`relative inline-flex items-center rounded-md border border-gray-300 px-4 py-2 text-sm font-medium text-gray-300 hover:bg-gray-50 hover:text-gray-700 dark:border-gray-700 dark:bg-gray-800 dark:text-white ${link.active ? 'bg-blue-600 text-white dark:bg-blue-700' : 'dark:hover:bg-gray-700'}`}
